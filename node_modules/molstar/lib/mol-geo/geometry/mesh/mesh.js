...
import { Vec3, Mat4, Mat3, Vec4 } from '../../../mol-math/linear-algebra.js';
import { Sphere3D } from '../../../mol-math/geometry.js';
import { transformPositionArray, transformDirectionArray, computeIndexedVertexNormals, createGroupMapping } from '../../util.js';
...
import { ChunkedArray, hashFnv32a, invertCantorPairing, sortedCantorPairing } from '../../../mol-data/util.js';
...
import { createInteriorValues, getInteriorParam, updateInteriorValues } from '../interior.js';
...
(function (Mesh) {
    ...
    function createValuesSimple(mesh, props, colorValue, sizeValue, transform) {
        ...
        const p = { ...PD.getDefaultValues(Mesh.Params), ...props };
