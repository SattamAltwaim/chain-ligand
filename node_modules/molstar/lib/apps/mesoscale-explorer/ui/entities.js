 ...
 */
import { PluginReactContext, PluginUIComponent } from '../../../mol-plugin-ui/base.js';
import { Button, ControlGroup, IconButton } from '../../../mol-plugin-ui/controls/common.js';
import { ArrowDropDownSvg, ArrowRightSvg, CloseSvg, VisibilityOffOutlinedSvg, VisibilityOutlinedSvg, ContentCutSvg, BrushSvg, SearchSvg, TooltipTextSvg, TooltipTextOutlineSvg, PlusBoxSvg, MinusBoxSvg } from '../../../mol-plugin-ui/controls/icons.js';
import { PluginCommands } from '../../../mol-plugin/commands.js';
import { StateSelection } from '../../../mol-state/index.js';
import { ParameterControls, ParameterMappingControl, SelectControl } from '../../../mol-plugin-ui/controls/parameters.js';
import { ParamDefinition as PD } from '../../../mol-util/param-definition.js';
import { Clip } from '../../../mol-util/clip.js';
import { Color } from '../../../mol-util/color/index.js';
import { CombinedColorControl } from '../../../mol-plugin-ui/controls/color.js';
import { MarkerAction } from '../../../mol-util/marker-action.js';
import { EveryLoci, Loci } from '../../../mol-model/loci.js';
import { deepEqual } from '../../../mol-util/index.js';
import { ColorValueParam, ColorParams, DimLightness, LightnessParams, LodParams, AnimationParams, MesoscaleGroup, OpacityParams, SimpleClipParams, createClipMapping, getClipObjects, getDistinctGroupColors, RootParams, MesoscaleState, getRoots, getAllGroups, getAllLeafGroups, getFilteredEntities, getAllFilteredEntities, getGroups, getEntities, getAllEntities, getEntityLabel, updateColors, getGraphicsModeProps, MesoscaleStateParams, setGraphicsCanvas3DProps, PatternParams, expandAllGroups, EmissiveParams, IllustrativeParams, getCellDescription, getEntityDescription, getEveryEntity } from '../data/state.js';
...
import { ColorLoaderControls } from './states.js';
...
export class GroupNode extends Node {
    ...
    render() {
        ...
        const animationValue = (_e = this.cell.params) === null || _e === void 0 ? void 0 : _e.values.animation;
        const isRoot = (_f = this.cell.params) === null || _f === void 0 ? void 0 : _f.values.root;
...
export class EntityNode extends Node {
    ...
    get animationValue() {
        var _a, _b, _c;
        const p = (_c = (_b = (_a = this.cell.transform.params) === null || _a === void 0 ? void 0 : _a.type) === null || _b === void 0 ? void 0 : _b.params) === null || _c === void 0 ? void 0 : _c.animation;
        if (!p)
            return;
        return {
