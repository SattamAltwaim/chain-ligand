 ...
 */
import { readCcp4Header, readCcp4Slices, getCcp4DataOffset, getCcp4ValueType } from '../../../../mol-io/reader/ccp4/parser.js';
import { getCcp4Origin, getCcp4Size } from '../../../../mol-model-formats/volume/ccp4.js';
...
export async function readSlices(data) {
    ...
    await readCcp4Slices(originalHeader, slices.buffer, data.file, header.dataOffset + sliceByteOffset, sliceByteCount, header.littleEndian);
...
export const Ccp4Provider = { readHeader, readSlices };
