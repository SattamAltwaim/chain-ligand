...
export declare const StructureGaussianWireframeParams: {
    sizeFactor: PD.Numeric;
    lineSizeAttenuation: PD.BooleanParam;
    ignoreHydrogens: PD.BooleanParam;
    ignoreHydrogensVariant: PD.Select<"all" | "non-polar">;
...
export declare function StructureGaussianWireframeVisual(materialId: number): ComplexVisual<StructureGaussianWireframeParams>;
