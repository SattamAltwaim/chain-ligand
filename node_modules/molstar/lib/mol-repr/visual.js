 ...
 */
import { Loci, isEmptyLoci, isEveryLoci, EveryLoci } from '../mol-model/loci.js';
import { applyMarkerAction, getMarkerInfo, setMarkerValue, getPartialMarkerAverage, MarkerActions } from '../mol-util/marker-action.js';
import { Mat4 } from '../mol-math/linear-algebra.js';
import { updateTransformData, fillIdentityTransform } from '../mol-geo/geometry/transform-data.js';
import { calculateTransformBoundingSphere } from '../mol-gl/renderable/util.js';
import { ValueCell } from '../mol-util/index.js';
import { createOverpaint, clearOverpaint, applyOverpaintColor } from '../mol-geo/geometry/overpaint-data.js';
import { Interval } from '../mol-data/int/interval.js';
import { createTransparency, clearTransparency, applyTransparencyValue, getTransparencyAverage, getTransparencyMin } from '../mol-geo/geometry/transparency-data.js';
import { createClipping, applyClippingGroups, clearClipping } from '../mol-geo/geometry/clipping-data.js';
import { getMarkersAverage } from '../mol-geo/geometry/marker-data.js';
import { getColorSmoothingProps, hasColorSmoothingProp } from '../mol-geo/geometry/base.js';
import { applyMeshEmissiveSmoothing, applyMeshOverpaintSmoothing, applyMeshSubstanceSmoothing, applyMeshTransparencySmoothing } from '../mol-geo/geometry/mesh/color-smoothing.js';
import { applyTextureMeshEmissiveSmoothing, applyTextureMeshOverpaintSmoothing, applyTextureMeshSubstanceSmoothing, applyTextureMeshTransparencySmoothing } from '../mol-geo/geometry/texture-mesh/color-smoothing.js';
import { applySubstanceMaterial, clearSubstance, createSubstance } from '../mol-geo/geometry/substance-data.js';
import { applyEmissiveValue, clearEmissive, createEmissive, getEmissiveAverage } from '../mol-geo/geometry/emissive-data.js';
import { applyWiggleValue, clearWiggle, createWiggle, getWiggleAverage } from '../mol-geo/geometry/wiggle-data.js';
export { Visual };
var Visual;
(function (Visual) {
