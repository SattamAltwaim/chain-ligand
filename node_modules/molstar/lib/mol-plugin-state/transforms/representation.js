...
import { unwindStructureAssembly, explodeStructure, spinStructure, SpinStructureParams, getSpinStructureAxisAndOrigin } from '../animation/helpers.js';
...
import { BaseGeometry, hasColorSmoothingProp } from '../../mol-geo/geometry/base.js';
import { Script } from '../../mol-script/script.js';
import { UnitcellParams, UnitcellRepresentation, getUnitcellData } from '../../mol-repr/shape/model/unitcell.js';
import { DistanceParams, DistanceRepresentation } from '../../mol-repr/shape/loci/distance.js';
import { getDistanceDataFromStructureSelections, getLabelDataFromStructureSelections, getOrientationDataFromStructureSelections, getAngleDataFromStructureSelections, getDihedralDataFromStructureSelections, getPlaneDataFromStructureSelections } from './helpers.js';
import { LabelParams, LabelRepresentation } from '../../mol-repr/shape/loci/label.js';
import { OrientationRepresentation, OrientationParams } from '../../mol-repr/shape/loci/orientation.js';
import { AngleParams, AngleRepresentation } from '../../mol-repr/shape/loci/angle.js';
import { DihedralParams, DihedralRepresentation } from '../../mol-repr/shape/loci/dihedral.js';
...
const WiggleStructureRepresentation3DFromScript = PluginStateTransform.BuiltIn({
    ...
    update({ a, b, newParams, oldParams }) {
        ...
        if (Wiggle.areEqual(oldWiggle, newWiggle))
            return StateTransformer.UpdateResult.Unchanged;
