...
import { uint8ToString } from '../../common/binary.js';
...
export async function readDsn6Header(file) {
...
export async function parseDsn6Values(header, source, target, littleEndian) {
    if (!littleEndian) {
