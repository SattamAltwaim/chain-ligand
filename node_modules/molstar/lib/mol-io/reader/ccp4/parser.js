...
import { FileHandle } from '../../common/file-handle.js';
import { SimpleBuffer } from '../../../mol-io/common/simple-buffer.js';
import { TypedArrayValueType, getElementByteSize, readTypedArray, createTypedArrayBufferContext } from '../../../mol-io/common/typed-array.js';
export async function readCcp4Header(file) {
    const headerSize = 1024;
    const { buffer } = await file.readBuffer(0, headerSize);
    // 53  MAP         Character string 'MAP ' to identify file type
    const MAP = String.fromCharCode(buffer.readUInt8(52 * 4), buffer.readUInt8(52 * 4 + 1), buffer.readUInt8(52 * 4 + 2), buffer.readUInt8(52 * 4 + 3) || 32 // null as space
    );
    if (MAP !== 'MAP ') {
