...
const property_1 = require("../../common/property.js");
var ComponentBond;
(function (ComponentBond) {
    ...
    function getNormalized(map, compId, atomId, isHydrogen) {
    ...
    class Pairs {
        get(otherAtomId, isHydrogen) {
            return getNormalized(this.map, this.compId, otherAtomId, isHydrogen);
        }
        constructor(atomId, compId) {
            this.atomId = atomId;
            this.compId = compId;
            this.map = new Map();
        }
    }
    ComponentBond.Pairs = Pairs;
    class Entry {
