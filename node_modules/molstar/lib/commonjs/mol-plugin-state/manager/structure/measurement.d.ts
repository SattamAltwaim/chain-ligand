...
import { StateTransform, StateTransformer, StateObject, StateObjectCell } from '../../../mol-state/index.js';
...
import { LociLabelTextParams } from '../../../mol-repr/shape/loci/common.js';
import { LineParams } from '../../../mol-repr/structure/representation/line.js';
...
declare class StructureMeasurementManager extends StatefulPluginComponent<StructureMeasurementManagerState> {
    ...
    addDistance(a: StructureElement.Loci, b: StructureElement.Loci, options?: StructureMeasurementManagerAddOptions & {
        ...
        selection: import("../../../mol-state/index.js").StateObjectSelector<PluginStateObject.Molecule.Structure.Selections, StateTransformer<PluginStateObject.Root, PluginStateObject.Molecule.Structure.Selections, PD.Normalize<{
        ...
        representation: import("../../../mol-state/index.js").StateObjectSelector<PluginStateObject.Shape.Representation3D, StateTransformer<PluginStateObject.Molecule.Structure.Selections, PluginStateObject.Shape.Representation3D, PD.Normalize<{
            visuals: ("text" | "lines")[];
            unitLabel: string;
            borderWidth: number;
            customText: string;
            ...
            fontFamily: import("../../../mol-geo/geometry/text/font-atlas.js").FontFamily;
            fontQuality: number;
            fontStyle: import("../../../mol-geo/geometry/text/font-atlas.js").FontStyle;
            fontVariant: import("../../../mol-geo/geometry/text/font-atlas.js").FontVariant;
            fontWeight: import("../../../mol-geo/geometry/text/font-atlas.js").FontWeight;
            alpha: number;
    ...
    addOrderLabels(locis: StructureElement.Loci[]): Promise<{
        representation: import("../../../mol-state/index.js").StateObjectSelector<StateObject<any, StateObject.Type<any>>, StateTransformer<StateObject<any, StateObject.Type<any>>, StateObject<any, StateObject.Type<any>>, any>> | import("../../../mol-state/index.js").StateObjectSelector<StateObject<any, StateObject.Type<any>>, StateTransformer<never, PluginStateObject.Group, PD.Normalize<{
            label: string;
