...
const structure_set_1 = require("../../../mol-model/structure/query/utils/structure-set.js");
const state_1 = require("../../../mol-plugin/behavior/static/state.js");
...
const structure_overpaint_1 = require("../../helpers/structure-overpaint.js");
const structure_representation_params_1 = require("../../helpers/structure-representation-params.js");
const structure_selection_query_1 = require("../../helpers/structure-selection-query.js");
const representation_1 = require("../../transforms/representation.js");
const clipping_1 = require("../../../mol-theme/clipping.js");
const structure_clipping_1 = require("../../helpers/structure-clipping.js");
const structure_transparency_1 = require("../../helpers/structure-transparency.js");
const structure_focus_representation_1 = require("../../../mol-plugin/behavior/dynamic/selection/structure-focus-representation.js");
const structure_substance_1 = require("../../helpers/structure-substance.js");
const material_1 = require("../../../mol-util/material.js");
const clip_1 = require("../../../mol-util/clip.js");
const structure_emissive_1 = require("../../helpers/structure-emissive.js");
const structure_wiggle_1 = require("../../helpers/structure-wiggle.js");
const interior_1 = require("../../../mol-geo/geometry/interior.js");
const animation_1 = require("../../../mol-geo/geometry/animation.js");
        ...
        return this.plugin.dataTransaction(async (ctx) => {
            ...
            for (const s of xs) {
                if (params.action.name === 'color') {
                    ...
                    const p = params.action.params;
                    await (0, structure_wiggle_1.setStructureWiggle)(this.plugin, s.components, p.value, getLoci, params.representations);
                }
            }
        }, { canUndo: 'Apply Theme' });
    }
...
(function (StructureComponentManager) {
    StructureComponentManager.OptionsParams = {
        ...
        interior: (0, interior_1.getInteriorParam)(),
        animation: (0, animation_1.getAnimationParam)(),
    };
    ...
    function getThemeParams(plugin, pivot) {
        ...
        return {
            ...
            action: param_definition_1.ParamDefinition.MappedStatic('color', {
                ...
                wiggle: param_definition_1.ParamDefinition.Group({
                    value: param_definition_1.ParamDefinition.Numeric(1, { min: 0, max: 5, step: 0.01 }),
                }, { isFlat: true }),
            }),
