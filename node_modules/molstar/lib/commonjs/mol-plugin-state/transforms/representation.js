...
const unit_transforms_1 = require("../../mol-model/structure/structure/util/unit-transforms.js");
const helpers_1 = require("../animation/helpers.js");
const color_1 = require("../../mol-util/color/index.js");
const overpaint_1 = require("../../mol-theme/overpaint.js");
const transparency_1 = require("../../mol-theme/transparency.js");
const base_1 = require("../../mol-geo/geometry/base.js");
const script_1 = require("../../mol-script/script.js");
const unitcell_1 = require("../../mol-repr/shape/model/unitcell.js");
const distance_1 = require("../../mol-repr/shape/loci/distance.js");
const helpers_2 = require("./helpers.js");
const label_1 = require("../../mol-repr/shape/loci/label.js");
const orientation_1 = require("../../mol-repr/shape/loci/orientation.js");
const angle_1 = require("../../mol-repr/shape/loci/angle.js");
const dihedral_1 = require("../../mol-repr/shape/loci/dihedral.js");
const symmetry_1 = require("../../mol-model-formats/structure/property/symmetry.js");
const clipping_1 = require("../../mol-theme/clipping.js");
const type_helpers_1 = require("../../mol-util/type-helpers.js");
const mesh_1 = require("../../mol-geo/geometry/mesh/mesh.js");
const shape_1 = require("./shape.js");
const shape_2 = require("../../mol-model/shape.js");
const plane_1 = require("../../mol-repr/shape/loci/plane.js");
const substance_1 = require("../../mol-theme/substance.js");
...
const emissive_1 = require("../../mol-theme/emissive.js");
const wiggle_1 = require("../../mol-theme/wiggle.js");
...
const WiggleStructureRepresentation3DFromScript = objects_1.PluginStateTransform.BuiltIn({
    ...
    params: () => ({
        layers: param_definition_1.ParamDefinition.ObjectList({
            script: param_definition_1.ParamDefinition.Script((0, script_1.Script)('(sel.atom.all)', 'mol-script')),
            value: param_definition_1.ParamDefinition.Numeric(5, { min: 0, max: 1, step: 0.01 }, { label: 'Wiggle' }),
        }, e => `Wiggle (${e.value})`, {
            defaultValue: [{
                    script: (0, script_1.Script)('(sel.atom.all)', 'mol-script'),
                    value: 1,
    ...
    apply({ a, params }) {
        const structure = a.data.sourceData;
        const geometryVersion = a.data.repr.geometryVersion;
        const wiggle = wiggle_1.Wiggle.ofScript(params.layers, structure);
        return new objects_1.PluginStateObject.Molecule.Structure.Representation3DState({
            state: { wiggle },
            initialState: { wiggle: wiggle_1.Wiggle.Empty },
            info: { structure, geometryVersion },
            repr: a.data.repr
    ...
    update({ a, b, newParams, oldParams }) {
        ...
        const newWiggle = wiggle_1.Wiggle.ofScript(newParams.layers, newStructure);
        if (wiggle_1.Wiggle.areEqual(oldWiggle, newWiggle))
            return mol_state_1.StateTransformer.UpdateResult.Unchanged;
...
exports.WiggleStructureRepresentation3DFromScript = WiggleStructureRepresentation3DFromScript;
const WiggleStructureRepresentation3DFromBundle = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply({ a, params }) {
        const structure = a.data.sourceData;
        const geometryVersion = a.data.repr.geometryVersion;
        const wiggle = wiggle_1.Wiggle.ofBundle(params.layers, structure);
        return new objects_1.PluginStateObject.Molecule.Structure.Representation3DState({
            state: { wiggle },
            initialState: { wiggle: wiggle_1.Wiggle.Empty },
            info: { structure, geometryVersion },
    ...
    update({ a, b, newParams, oldParams }) {
        ...
        if (a.data.repr !== b.data.repr)
            return mol_state_1.StateTransformer.UpdateResult.Recreate;
        const oldWiggle = b.data.state.wiggle;
        const newWiggle = wiggle_1.Wiggle.ofBundle(newParams.layers, newStructure);
        if (wiggle_1.Wiggle.areEqual(oldWiggle, newWiggle))
            return mol_state_1.StateTransformer.UpdateResult.Unchanged;
        info.geometryVersion = a.data.repr.geometryVersion;
        b.data.state.wiggle = newWiggle;
...
exports.WiggleStructureRepresentation3DFromBundle = WiggleStructureRepresentation3DFromBundle;
const ThemeStrengthRepresentation3D = objects_1.PluginStateTransform.BuiltIn({
    ...
    params: () => ({
        ...
        wiggleStrength: param_definition_1.ParamDefinition.Numeric(1, { min: 0, max: 1, step: 0.01 }),
    })
})({
    canAutoUpdate() {
        return true;
    ...
    update({ a, b, newParams, oldParams }) {
        ...
        if (newParams.overpaintStrength === ((_a = b.data.state.themeStrength) === null || _a === void 0 ? void 0 : _a.overpaint) &&
            ...
            newParams.wiggleStrength === ((_e = b.data.state.themeStrength) === null || _e === void 0 ? void 0 : _e.wiggle))
            return mol_state_1.StateTransformer.UpdateResult.Unchanged;
    ...
    interpolate(src, tar, t) {
        return {
            ...
            wiggleStrength: (0, interpolate_1.lerp)(src.wiggleStrength, tar.wiggleStrength, t),
        };
    }
});
...
const VolumeRepresentation3D = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply({ a, params }, plugin) {
        return mol_task_1.Task.create('Volume Representation', async (ctx) => {
            ...
            await theme_1.Theme.ensureDependencies(propertyCtx, plugin.representation.volume.themes, { volume: a.data }, params);
    ...
    update({ a, b, oldParams, newParams }, plugin) {
        return mol_task_1.Task.create('Volume Representation', async (ctx) => {
            ...
            // TODO: if themes had a .needsUpdate method the following block could
            //       be optimized and only executed conditionally
            theme_1.Theme.releaseDependencies(plugin.representation.volume.themes, { volume: b.data.sourceData }, oldParams);
            await theme_1.Theme.ensureDependencies(propertyCtx, plugin.representation.volume.themes, { volume: a.data }, newParams);
            b.data.repr.setTheme(theme_1.Theme.create(plugin.representation.volume.themes, { volume: a.data, locationKinds: provider.locationKinds }, newParams));
            const props = { ...b.data.repr.props, ...newParams.type.params };
    ...
    dispose({ b, params }, plugin) {
        ...
        theme_1.Theme.releaseDependencies(plugin.representation.volume.themes, { volume }, params);
    },
});
