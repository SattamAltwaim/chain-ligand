...
const data_source_1 = require("./data-source.js");
const mol_task_1 = require("../mol-task/index.js");
const nodejs_shims_1 = require("./nodejs-shims.js");
const array_1 = require("../mol-data/util/array.js");
var Asset;
(function (Asset) {
    ...
    Asset.getUrl = getUrl;
    function getUrlAsset(manager, url, body, headers) {
...
class AssetManager {
    ...
    get assets() {
        return (0, array_1.iterableToArray)(this._assets.values());
    }
    tryFindUrl(url, body, headers) {
        ...
        while (true) {
            ...
            if (Asset.isUrl(asset) && asset.url === url && (asset.body || '') === (body || '') && urlHeadersEqual(asset.headers, headers))
                return asset;
        }
    }
