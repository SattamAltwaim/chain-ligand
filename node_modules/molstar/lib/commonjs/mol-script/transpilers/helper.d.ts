 ...
 */
import * as P from '../../mol-util/monadic-parser.js';
import { Expression } from '../language/expression.js';
import { KeywordDict, PropertyDict, FunctionDict, OperatorList } from './types.js';
import { escapeRegExp } from '../../mol-util/string.js';
export { escapeRegExp };
export declare function prefix(opParser: P.MonadicParser<any>, nextParser: P.MonadicParser<any>, mapFn: any): P.MonadicParser<any>;
export declare function postfix(opParser: P.MonadicParser<any>, nextParser: P.MonadicParser<any>, mapFn: any): P.MonadicParser<any>;
...
export declare function binaryLeft(opParser: P.MonadicParser<any>, nextParser: P.MonadicParser<any>, mapFn: any): P.MonadicParser<any>;
/**
