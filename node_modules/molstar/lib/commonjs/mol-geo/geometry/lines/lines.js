...
const color_data_1 = require("../color-data.js");
const marker_data_1 = require("../marker-data.js");
const size_data_1 = require("../size-data.js");
const location_iterator_1 = require("../../util/location-iterator.js");
const lines_builder_1 = require("./lines-builder.js");
const param_definition_1 = require("../../../mol-util/param-definition.js");
const util_2 = require("../../../mol-gl/renderable/util.js");
const geometry_1 = require("../../../mol-math/geometry.js");
const base_1 = require("../base.js");
const overpaint_data_1 = require("../overpaint-data.js");
const transparency_data_1 = require("../transparency-data.js");
const util_3 = require("../../../mol-data/util.js");
const clipping_data_1 = require("../clipping-data.js");
const substance_data_1 = require("../substance-data.js");
const emissive_data_1 = require("../emissive-data.js");
const wiggle_data_1 = require("../wiggle-data.js");
const animation_1 = require("../animation.js");
var Lines;
(function (Lines) {
    function create(mappings, indices, groups, starts, ends, strips, lineCount, vertexCount, stripCount, lines) {
        return lines ?
    ...
    function fromArrays(mappings, indices, groups, starts, ends, strips, lineCount, vertexCount, stripCount) {
        ...
        const lines = {
            ...
            stripCount: mol_util_1.ValueCell.create(stripCount),
            stripBuffer: mol_util_1.ValueCell.create(strips),
            get boundingSphere() {
    ...
    function update(mappings, indices, groups, starts, ends, strips, lineCount, vertexCount, stripCount, lines) {
        ...
        mol_util_1.ValueCell.updateIfChanged(lines.stripCount, stripCount);
        mol_util_1.ValueCell.update(lines.stripBuffer, strips);
        return lines;
    }
    function transform(lines, t) {
        const start = lines.startBuffer.ref.value;
        (0, util_1.transformPositionArray)(t, start, 0, lines.vertexCount);
        mol_util_1.ValueCell.update(lines.startBuffer, start);
        const end = lines.endBuffer.ref.value;
        (0, util_1.transformPositionArray)(t, end, 0, lines.vertexCount);
    ...
    function createValues(lines, transform, locationIt, theme, props) {
        ...
        const size = (0, size_data_1.createSizes)(locationIt, positionIt, theme.size);
        ...
        const wiggle = (0, wiggle_data_1.createEmptyWiggle)();
        ...
        return {
            ...
            ...(0, animation_1.createAnimationValues)(props.animation),
    ...
    function updateValues(values, props) {
        ...
        (0, animation_1.updateAnimationValues)(values, props.animation);
    }
