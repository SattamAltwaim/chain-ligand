...
const font_atlas_1 = require("./font-atlas.js");
...
(function (Text) {
    ...
    function createValues(text, transform, locationIt, theme, props) {
        ...
        const scale = (0, size_data_1.getMaxSize)(size) * props.sizeFactor;
    ...
    function updateBoundingSphere(values, text) {
        const scale = (0, size_data_1.getMaxSize)(values) * values.uSizeFactor.ref.value;
