...
const param_mapping_1 = require("../../../mol-util/param-mapping.js");
const distinct_1 = require("../../../mol-util/color/distinct.js");
const hcl_1 = require("../../../mol-util/color/spaces/hcl.js");
...
function getGrayscaleColors(count, luminance, variability) {
    const out = [];
    const pcg = new hash_functions_1.PCG();
    for (let i = 0; i < count; ++i) {
        const l = (0, interpolate_1.saturate)(luminance / 100);
        const v = (0, interpolate_1.saturate)(variability / 180) * pcg.float();
...
exports.AnimationParams = (0, animation_1.getAnimationParam)().params;
...
exports.MesoscaleGroupParams = {
    ...
    animation: param_definition_1.ParamDefinition.Group(exports.AnimationParams),
};
