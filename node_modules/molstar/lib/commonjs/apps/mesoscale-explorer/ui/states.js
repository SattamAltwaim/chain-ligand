...
exports.MesoProceduralAnimationControls = exports.MesoQuickStyles = exports.MesoQuickStylesControls = exports.ExplorerInfo = exports.SnapshotControls = exports.SessionControls = exports.ExampleControls = exports.LoaderControls = exports.DatabaseControls = exports.LoadModel = exports.LoadExample = exports.LoadDatabase = void 0;
...
const trajectory_1 = require("../../../mol-plugin-state/formats/trajectory.js");
const objects_1 = require("../../../mol-plugin-state/objects.js");
const common_1 = require("../../../mol-plugin-ui/controls/common.js");
const icons_1 = require("../../../mol-plugin-ui/controls/icons.js");
const base_1 = require("../../../mol-plugin-ui/base.js");
const apply_action_1 = require("../../../mol-plugin-ui/state/apply-action.js");
const snapshots_1 = require("../../../mol-plugin-ui/state/snapshots.js");
...
const file_info_1 = require("../../../mol-util/file-info.js");
const param_definition_1 = require("../../../mol-util/param-definition.js");
const preset_1 = require("../data/cellpack/preset.js");
const preset_2 = require("../data/generic/preset.js");
const preset_3 = require("../data/mmcif/preset.js");
const preset_4 = require("../data/petworld/preset.js");
const state_1 = require("../data/state.js");
...
class MesoProceduralAnimationControls extends base_1.CollapsableControls {
    defaultState() {
        return {
            isCollapsed: true,
            header: 'Procedural Animation',
            brand: { accent: 'gray', svg: icons_1.AnimationSvg }
        };
    }
    renderControls() {
        return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(MesoProceduralAnimation, {}) });
    }
}
exports.MesoProceduralAnimationControls = MesoProceduralAnimationControls;
class MesoProceduralAnimation extends base_1.PluginUIComponent {
    isMembrane(cell) {
        var _a, _b;
        return (_b = (_a = cell.transform.tags) === null || _a === void 0 ? void 0 : _a.some(t => t.includes('mem'))) !== null && _b !== void 0 ? _b : false;
    }
    async dynamics() {
        const update = this.plugin.state.data.build();
        const entities = (0, state_1.getAllEntities)(this.plugin);
        const groups = (0, state_1.getAllGroups)(this.plugin);
    ...
    render() {
        return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsxs)("div", { className: 'msp-flex-row', children: [(0, jsx_runtime_1.jsx)(common_1.Button, { noOverflow: true, title: 'Enable wiggle for all entities and tumble for non-membrane entities', onClick: () => this.dynamics(), style: { width: 'auto' }, children: "Dynamics" }), (0, jsx_runtime_1.jsx)(common_1.Button, { noOverflow: true, title: 'Set wiggle and tumble amplitude to zero for all entities', onClick: () => this.clear(), style: { width: 'auto' }, children: "Clear" })] }) });
    }
}
