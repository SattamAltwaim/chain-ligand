...
import { AnimationSvg, MagicWandSvg } from '../../../mol-plugin-ui/controls/icons.js';
...
export declare class MesoProceduralAnimationControls extends CollapsableControls {
    defaultState(): {
        isCollapsed: boolean;
        header: string;
        brand: {
            accent: "gray";
            svg: typeof AnimationSvg;
        };
    };
    renderControls(): import("react/jsx-runtime").JSX.Element;
}
