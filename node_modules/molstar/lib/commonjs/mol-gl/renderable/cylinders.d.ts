...
import { AttributeSpec, Values, ElementsSpec, ValueSpec, DefineSpec, UniformSpec, GlobalDefines } from './schema.js';
export declare const CylindersSchema: {
    ...
    tWiggle: import("./schema.js").TextureSpec<"image-uint8">;
...
export declare function CylindersRenderable(ctx: WebGLContext, id: number, values: CylindersValues, state: RenderableState, materialId: number, transparency: Transparency, globals: GlobalDefines): Renderable<CylindersValues>;
