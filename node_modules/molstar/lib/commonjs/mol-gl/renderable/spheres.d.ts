...
import { Values, ValueSpec, DefineSpec, UniformSpec, TextureSpec, GlobalDefines } from './schema.js';
...
export declare function SpheresRenderable(ctx: WebGLContext, id: number, values: SpheresValues, state: RenderableState, materialId: number, transparency: Transparency, globals: GlobalDefines): Renderable<SpheresValues>;
