...
import { AttributeSpec, DefineSpec, Values, ElementsSpec, UniformSpec, GlobalDefines, ValueSpec } from './schema.js';
...
export declare function LinesRenderable(ctx: WebGLContext, id: number, values: LinesValues, state: RenderableState, materialId: number, transparency: Transparency, globals: GlobalDefines): Renderable<LinesValues>;
