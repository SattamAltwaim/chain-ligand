...
const compat_1 = require("./webgl/compat.js");
const type_helpers_1 = require("../mol-util/type-helpers.js");
const shaderCodeId = (0, id_factory_1.idFactory)();
const apply_fog_glsl_1 = require("./shader/chunks/apply-fog.glsl.js");
const apply_interior_color_glsl_1 = require("./shader/chunks/apply-interior-color.glsl.js");
const apply_light_color_glsl_1 = require("./shader/chunks/apply-light-color.glsl.js");
const apply_marker_color_glsl_1 = require("./shader/chunks/apply-marker-color.glsl.js");
const assign_clipping_varying_glsl_1 = require("./shader/chunks/assign-clipping-varying.glsl.js");
const assign_color_varying_glsl_1 = require("./shader/chunks/assign-color-varying.glsl.js");
const assign_group_glsl_1 = require("./shader/chunks/assign-group.glsl.js");
const assign_marker_varying_glsl_1 = require("./shader/chunks/assign-marker-varying.glsl.js");
const assign_material_color_glsl_1 = require("./shader/chunks/assign-material-color.glsl.js");
const assign_position_glsl_1 = require("./shader/chunks/assign-position.glsl.js");
const assign_size_glsl_1 = require("./shader/chunks/assign-size.glsl.js");
const check_picking_alpha_glsl_1 = require("./shader/chunks/check-picking-alpha.glsl.js");
const check_transparency_glsl_1 = require("./shader/chunks/check-transparency.glsl.js");
const clip_instance_glsl_1 = require("./shader/chunks/clip-instance.glsl.js");
const clip_pixel_glsl_1 = require("./shader/chunks/clip-pixel.glsl.js");
const color_frag_params_glsl_1 = require("./shader/chunks/color-frag-params.glsl.js");
const color_vert_params_glsl_1 = require("./shader/chunks/color-vert-params.glsl.js");
const common_animation_glsl_1 = require("./shader/chunks/common-animation.glsl.js");
const common_clip_glsl_1 = require("./shader/chunks/common-clip.glsl.js");
const common_frag_params_glsl_1 = require("./shader/chunks/common-frag-params.glsl.js");
const common_vert_params_glsl_1 = require("./shader/chunks/common-vert-params.glsl.js");
const common_glsl_1 = require("./shader/chunks/common.glsl.js");
const fade_lod_glsl_1 = require("./shader/chunks/fade-lod.glsl.js");
const float_to_rgba_glsl_1 = require("./shader/chunks/float-to-rgba.glsl.js");
const light_frag_params_glsl_1 = require("./shader/chunks/light-frag-params.glsl.js");
const normal_frag_params_glsl_1 = require("./shader/chunks/normal-frag-params.glsl.js");
const read_from_texture_glsl_1 = require("./shader/chunks/read-from-texture.glsl.js");
const rgba_to_float_glsl_1 = require("./shader/chunks/rgba-to-float.glsl.js");
const size_vert_params_glsl_1 = require("./shader/chunks/size-vert-params.glsl.js");
const texture3d_from_1d_trilinear_glsl_1 = require("./shader/chunks/texture3d-from-1d-trilinear.glsl.js");
const texture3d_from_2d_linear_glsl_1 = require("./shader/chunks/texture3d-from-2d-linear.glsl.js");
const texture3d_from_2d_nearest_glsl_1 = require("./shader/chunks/texture3d-from-2d-nearest.glsl.js");
const wboit_write_glsl_1 = require("./shader/chunks/wboit-write.glsl.js");
const dpoit_write_glsl_1 = require("./shader/chunks/dpoit-write.glsl.js");
const ShaderChunks = {
    ...
    common_animation: common_animation_glsl_1.common_animation,
...
;
const points_vert_1 = require("./shader/points.vert.js");
const points_frag_1 = require("./shader/points.frag.js");
...
const spheres_vert_1 = require("./shader/spheres.vert.js");
const spheres_frag_1 = require("./shader/spheres.frag.js");
...
const cylinders_vert_1 = require("./shader/cylinders.vert.js");
const cylinders_frag_1 = require("./shader/cylinders.frag.js");
...
const text_vert_1 = require("./shader/text.vert.js");
const text_frag_1 = require("./shader/text.frag.js");
exports.TextShaderCode = ShaderCode('text', text_vert_1.text_vert, text_frag_1.text_frag, { fragDepth: 'optional', drawBuffers: 'optional' }, {}, ignoreDefineUnlit);
const lines_vert_1 = require("./shader/lines.vert.js");
const lines_frag_1 = require("./shader/lines.frag.js");
...
const mesh_vert_1 = require("./shader/mesh.vert.js");
const mesh_frag_1 = require("./shader/mesh.frag.js");
exports.MeshShaderCode = ShaderCode('mesh', mesh_vert_1.mesh_vert, mesh_frag_1.mesh_frag, { drawBuffers: 'optional' }, {}, ignoreDefine);
const direct_volume_vert_1 = require("./shader/direct-volume.vert.js");
const direct_volume_frag_1 = require("./shader/direct-volume.frag.js");
...
const image_vert_1 = require("./shader/image.vert.js");
const image_frag_1 = require("./shader/image.frag.js");
...
function getGlsl300FragPrefix(extensions, parameters, shaderExtensions, outTypes) {
    const prefix = [
        '#version 300 es',
...
function addShaderDefines(gl, extensions, parameters, defines, shaders) {
