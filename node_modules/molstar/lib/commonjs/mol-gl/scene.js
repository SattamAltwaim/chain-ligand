...
const render_object_1 = require("./render-object.js");
const object3d_1 = require("./object3d.js");
const sphere3d_1 = require("../mol-math/geometry/primitives/sphere3d.js");
const commit_queue_1 = require("./commit-queue.js");
...
var Scene;
(function (Scene) {
    function create(ctx, transparency = 'blended', globals = { dColorMarker: true, dLightCount: 1 }) {
        ...
        function add(o) {
            if (!renderableMap.has(o)) {
                const renderable = (0, render_object_1.createRenderable)(ctx, o, transparency, globals);
        ...
        function calculateHasAnimation() {
            ...
            for (let i = 0, il = primitives.length; i < il; ++i) {
                ...
                if (!p.state.visible)
                    continue;
                if ((((_a = p.values.uWiggleAmplitude) === null || _a === void 0 ? void 0 : _a.ref.value) > 0 || p.values.wiggleAverage.ref.value > 0) &&
                    ((_b = p.values.uWiggleSpeed) === null || _b === void 0 ? void 0 : _b.ref.value) > 0 &&
                    ((_c = p.values.uWiggleFrequency) === null || _c === void 0 ? void 0 : _c.ref.value) > 0)
                    return true;
                if (((_d = p.values.uTumbleAmplitude) === null || _d === void 0 ? void 0 : _d.ref.value) > 0 &&
                    ((_e = p.values.uTumbleSpeed) === null || _e === void 0 ? void 0 : _e.ref.value) > 0 &&
                    ((_f = p.values.uTumbleFrequency) === null || _f === void 0 ? void 0 : _f.ref.value) > 0)
                    return true;
            }
            return false;
        }
        return {
            ...
            setGlobals: (values) => {
                ...
                for (const r of renderables) {
                    value_cell_1.ValueCell.updateIfChanged(r.values.dColorMarker, values.dColorMarker);
                    value_cell_1.ValueCell.updateIfChanged(r.values.dLightCount, values.dLightCount);
                    r.update();
                }
            },
