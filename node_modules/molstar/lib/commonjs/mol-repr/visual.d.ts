...
import { MarkerAction, MarkerInfo } from '../mol-util/marker-action.js';
...
declare namespace Visual {
    ...
    export function setWiggle(renderObject: GraphicsRenderObject | undefined, wiggle: Wiggle, lociApply: LociApply, clear: boolean): void;
