...
function createVisualsMap() {
    return new map_1.HashMap(group => (0, util_1.hash2)(group.hashCode, group.transformHash), structure_1.Unit.SymmetryGroup.areInvariantElementsEqual);
}
function UnitsRepresentation(label, ctx, getParams, visualCtor) {
    ...
    function createOrUpdate(props = {}, structure) {
        ...
        return mol_task_1.Task.create('Creating or updating UnitsRepresentation', async (runtime) => {
            ...
            if (!_structure && !structure) {
                ...
                _groups = structure_1.StructureSymmetry.computeChildAwareTransformGroups(structure);
    ...
    function setState(state) {
        ...
        if (wiggle !== undefined && _structure) {
            newState.wiggle = wiggle_1.Wiggle.remap(wiggle, _structure);
        }
        if (themeStrength !== undefined)
