...
(function (Representation) {
    ...
    function updateState(state, update) {
        ...
        if (update.wiggle !== undefined)
            state.wiggle = update.wiggle;
    ...
    function createEmpty() {
        return {
            ...
            state: createState(),
            theme: theme_1.Theme.createEmpty(),
    ...
    Representation.createEmpty = createEmpty;
    class GeometryState {
        constructor() {
            this.curr = new Set();
            this.next = new Set();
...
let _EmptyRepresentation = undefined;
Object.defineProperty(Representation, 'Empty', {
    get: () => {
        return _EmptyRepresentation !== null && _EmptyRepresentation !== void 0 ? _EmptyRepresentation : (_EmptyRepresentation = Representation.createEmpty());
    }
});
