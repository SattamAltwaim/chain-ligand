...
function VolumeVisual(builder, materialId) {
    ...
    return {
        ...
        getLoci(pickingId) {
            return renderObject ? getLoci(pickingId, currentVolume, currentKey, currentProps, renderObject.id, geometry) : loci_1.EmptyLoci;
        },
        eachLocation(cb) {
            locationIt.reset();
        ...
        setWiggle(wiggle) {
            return visual_1.Visual.setWiggle(renderObject, wiggle, lociApply, true);
        },
