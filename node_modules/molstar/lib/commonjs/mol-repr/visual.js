...
const overpaint_data_1 = require("../mol-geo/geometry/overpaint-data.js");
const interval_1 = require("../mol-data/int/interval.js");
const transparency_data_1 = require("../mol-geo/geometry/transparency-data.js");
const clipping_data_1 = require("../mol-geo/geometry/clipping-data.js");
const marker_data_1 = require("../mol-geo/geometry/marker-data.js");
const base_1 = require("../mol-geo/geometry/base.js");
const color_smoothing_1 = require("../mol-geo/geometry/mesh/color-smoothing.js");
const color_smoothing_2 = require("../mol-geo/geometry/texture-mesh/color-smoothing.js");
const substance_data_1 = require("../mol-geo/geometry/substance-data.js");
const emissive_data_1 = require("../mol-geo/geometry/emissive-data.js");
const wiggle_data_1 = require("../mol-geo/geometry/wiggle-data.js");
var Visual;
(function (Visual) {
    ...
    function mark(renderObject, loci, action, lociApply, previous) {
        ...
        if (!(0, loci_1.isEveryLoci)(loci)) {
            ...
            lociApply(loci, interval => {
                intervalSize += interval_1.Interval.size(interval);
                return true;
            }, true);
            if (intervalSize === 0)
                return false;
        ...
        if ((0, loci_1.isEveryLoci)(loci)) {
            ...
            if (info.status !== -1) {
                ...
                changed = (0, marker_action_1.applyMarkerAction)(array, interval_1.Interval.ofLength(count), action);
            }
    ...
    function setOverpaint(renderObject, overpaint, lociApply, clear, smoothing) {
        ...
        for (let i = 0, il = overpaint.layers.length; i < il; ++i) {
            ...
            const apply = (interval) => {
                const start = interval_1.Interval.start(interval);
                const end = interval_1.Interval.end(interval);
                return clear
        ...
        if (smoothing && (0, base_1.hasColorSmoothingProp)(smoothing.props)) {
            ...
            if (geometry.kind === 'mesh') {
                ...
                if (csp) {
                    (0, color_smoothing_1.applyMeshOverpaintSmoothing)(renderObject.values, csp, webgl, overpaintTexture);
                ...
                const csp = (0, base_1.getColorSmoothingProps)(props.smoothColors, true, resolution);
                if (csp) {
                    (0, color_smoothing_2.applyTextureMeshOverpaintSmoothing)(renderObject.values, csp, webgl, overpaintTexture);
                    geometry.meta.overpaintTexture = renderObject.values.tOverpaintGrid.ref.value;
                }
            }
        }
    ...
    function setTransparency(renderObject, transparency, lociApply, clear, smoothing) {
        ...
        if (smoothing && (0, base_1.hasColorSmoothingProp)(smoothing.props)) {
            ...
            if (geometry.kind === 'mesh') {
                ...
                const csp = (0, base_1.getColorSmoothingProps)(props.smoothColors, true, resolution);
                if (csp) {
                    (0, color_smoothing_1.applyMeshTransparencySmoothing)(renderObject.values, csp, webgl, transparencyTexture);
                ...
                const csp = (0, base_1.getColorSmoothingProps)(props.smoothColors, true, resolution);
                if (csp) {
                    (0, color_smoothing_2.applyTextureMeshTransparencySmoothing)(renderObject.values, csp, webgl, transparencyTexture);
                    geometry.meta.transparencyTexture = renderObject.values.tTransparencyGrid.ref.value;
                }
            }
        }
    ...
    function setEmissive(renderObject, emissive, lociApply, clear, smoothing) {
        ...
        if (smoothing && (0, base_1.hasColorSmoothingProp)(smoothing.props)) {
            ...
            if (geometry.kind === 'mesh') {
                ...
                const csp = (0, base_1.getColorSmoothingProps)(props.smoothColors, true, resolution);
                if (csp) {
                    (0, color_smoothing_1.applyMeshEmissiveSmoothing)(renderObject.values, csp, webgl, emissiveTexture);
                ...
                const csp = (0, base_1.getColorSmoothingProps)(props.smoothColors, true, resolution);
                if (csp) {
                    (0, color_smoothing_2.applyTextureMeshEmissiveSmoothing)(renderObject.values, csp, webgl, emissiveTexture);
                    geometry.meta.emissiveTexture = renderObject.values.tEmissiveGrid.ref.value;
                }
            }
        }
    ...
    function setSubstance(renderObject, substance, lociApply, clear, smoothing) {
        ...
        if (smoothing && (0, base_1.hasColorSmoothingProp)(smoothing.props)) {
            ...
            if (geometry.kind === 'mesh') {
                ...
                const csp = (0, base_1.getColorSmoothingProps)(props.smoothColors, true, resolution);
                if (csp) {
                    (0, color_smoothing_1.applyMeshSubstanceSmoothing)(renderObject.values, csp, webgl, substanceTexture);
                ...
                const csp = (0, base_1.getColorSmoothingProps)(props.smoothColors, true, resolution);
                if (csp) {
                    (0, color_smoothing_2.applyTextureMeshSubstanceSmoothing)(renderObject.values, csp, webgl, substanceTexture);
                    geometry.meta.substanceTexture = renderObject.values.tSubstanceGrid.ref.value;
                }
            }
        }
    ...
    function setWiggle(renderObject, wiggle, lociApply, clear) {
        if (!renderObject)
            return;
        ...
        // ensure texture has right size and type
        const type = instanceGranularity.ref.value ? 'instance' : 'groupInstance';
        (0, wiggle_data_1.createWiggle)(wiggle.layers.length ? count : 0, type, renderObject.values);
        const { array } = tWiggle.ref.value;
        // clear if requested
        if (clear)
            (0, wiggle_data_1.clearWiggle)(array, 0, count);
        for (let i = 0, il = wiggle.layers.length; i < il; ++i) {
            const { loci, value } = wiggle.layers[i];
            const apply = (interval) => {
                const start = interval_1.Interval.start(interval);
                const end = interval_1.Interval.end(interval);
                return (0, wiggle_data_1.applyWiggleValue)(array, start, end, value);
            };
            lociApply(loci, apply, false);
        }
        mol_util_1.ValueCell.update(tWiggle, tWiggle.ref.value);
        mol_util_1.ValueCell.updateIfChanged(wiggleAverage, (0, wiggle_data_1.getWiggleAverage)(array, count));
        mol_util_1.ValueCell.updateIfChanged(dWiggleType, type);
        mol_util_1.ValueCell.updateIfChanged(dWiggle, wiggle.layers.length > 0);
    }
    Visual.setWiggle = setWiggle;
    function setThemeStrength(renderObject, strength) {
        if (renderObject) {
            ...
            mol_util_1.ValueCell.updateIfChanged(renderObject.values.uWiggleStrength, strength.wiggle);
        }
    }
