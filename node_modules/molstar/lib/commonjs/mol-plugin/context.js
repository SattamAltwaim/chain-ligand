...
const custom_property_1 = require("../mol-model-props/common/custom-property.js");
const data_1 = require("../mol-plugin-state/builder/data.js");
const structure_1 = require("../mol-plugin-state/builder/structure.js");
const registry_1 = require("../mol-plugin-state/formats/registry.js");
const structure_selection_query_1 = require("../mol-plugin-state/helpers/structure-selection-query.js");
const animation_1 = require("../mol-plugin-state/manager/animation.js");
const camera_1 = require("../mol-plugin-state/manager/camera.js");
const interactivity_1 = require("../mol-plugin-state/manager/interactivity.js");
const loci_label_1 = require("../mol-plugin-state/manager/loci-label.js");
const snapshots_1 = require("../mol-plugin-state/manager/snapshots.js");
const component_1 = require("../mol-plugin-state/manager/structure/component.js");
const focus_1 = require("../mol-plugin-state/manager/structure/focus.js");
const hierarchy_1 = require("../mol-plugin-state/manager/structure/hierarchy.js");
const measurement_1 = require("../mol-plugin-state/manager/structure/measurement.js");
const selection_1 = require("../mol-plugin-state/manager/structure/selection.js");
const hierarchy_2 = require("../mol-plugin-state/manager/volume/hierarchy.js");
const markdown_extensions_1 = require("../mol-plugin-state/manager/markdown-extensions.js");
const state_snapshots_1 = require("../mol-plugin-state/animation/built-in/state-snapshots.js");
const layout_1 = require("./layout.js");
const representation_1 = require("../mol-repr/representation.js");
const registry_2 = require("../mol-repr/structure/registry.js");
const registry_3 = require("../mol-repr/volume/registry.js");
...
const color_2 = require("../mol-util/color/index.js");
...
const log_entry_1 = require("../mol-util/log-entry.js");
const object_1 = require("../mol-util/object.js");
const rx_event_helper_1 = require("../mol-util/rx-event-helper.js");
const animation_loop_1 = require("./animation-loop.js");
const behavior_1 = require("./behavior.js");
const behavior_2 = require("./behavior/behavior.js");
...
const substructure_parent_helper_1 = require("./util/substructure-parent-helper.js");
const task_manager_1 = require("./util/task-manager.js");
const toast_1 = require("./util/toast.js");
const viewport_screenshot_1 = require("./util/viewport-screenshot.js");
const version_1 = require("./version.js");
const constants_1 = require("../mol-model/structure/structure/carbohydrates/constants.js");
const drag_and_drop_1 = require("../mol-plugin-state/manager/drag-and-drop.js");
const error_context_1 = require("../mol-util/error-context.js");
const container_1 = require("./container.js");
class PluginContext {
    get isInitialized() {
    ...
    async initViewerAsync(canvas, container, canvas3dContext) {
    ...
    _initContainer(options) {
        ...
        if (this.container)
            return true;
        const container = new container_1.PluginContainer({
            checkeredCanvasBackground: options === null || options === void 0 ? void 0 : options.checkeredCanvasBackground,
            canvas: (_a = options === null || options === void 0 ? void 0 : options.canvas3dContext) === null || _a === void 0 ? void 0 : _a.canvas
        });
        if (!this._initViewer(container.canvas, container.parent, options === null || options === void 0 ? void 0 : options.canvas3dContext)) {
            return false;
        }
        if (options === null || options === void 0 ? void 0 : options.checkeredCanvasBackground) {
            (_b = this.canvas3d) === null || _b === void 0 ? void 0 : _b.setProps({ checkeredTransparentBackground: true });
        }
    ...
    unmount() {
        var _a;
        (_a = this.container) === null || _a === void 0 ? void 0 : _a.unmount();
    }
    _initViewer(canvas, container, canvas3dContext) {
        ...
        try {
            ...
            if (!props) {
                ...
                if (((_e = props.renderer) === null || _e === void 0 ? void 0 : _e.backgroundColor) === void 0) {
                    props = (0, produce_1.produce)(props, p => {
                        if (p.renderer)
    ...
    initAnimations() {
        var _a;
        if (!((_a = this.spec.animations) === null || _a === void 0 ? void 0 : _a.length)) {
            ...
            this.managers.animation.register(state_snapshots_1.AnimateStateSnapshotTransition);
            return;
        }
    ...
    constructor(spec) {
        ...
        this.managers = {
            ...
            markdownExtensions: new markdown_extensions_1.MarkdownExtensionManager(this),
        ...
        this.customVolumeProperties = new custom_property_1.CustomProperty.Registry();
