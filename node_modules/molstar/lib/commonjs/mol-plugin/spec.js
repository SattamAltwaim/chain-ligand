...
const assembly_unwind_1 = require("../mol-plugin-state/animation/built-in/assembly-unwind.js");
const camera_spin_1 = require("../mol-plugin-state/animation/built-in/camera-spin.js");
const model_index_1 = require("../mol-plugin-state/animation/built-in/model-index.js");
...
const structure_focus_representation_1 = require("./behavior/dynamic/selection/structure-focus-representation.js");
const actions_1 = require("../mol-plugin-state/actions.js");
const volume_1 = require("../mol-plugin-state/actions/volume.js");
...
const state_interpolation_1 = require("../mol-plugin-state/animation/built-in/state-interpolation.js");
const spin_structure_1 = require("../mol-plugin-state/animation/built-in/spin-structure.js");
const camera_rock_1 = require("../mol-plugin-state/animation/built-in/camera-rock.js");
const time_1 = require("../mol-plugin-state/animation/built-in/time.js");
var PluginSpec;
(function (PluginSpec) {
...
const DefaultPluginSpec = () => ({
    actions: [
        ...
        PluginSpec.Action(transforms_1.StateTransforms.Model.StructureInstances),
        ...
        PluginSpec.Action(transforms_1.StateTransforms.Representation.WiggleStructureRepresentation3DFromScript),
        ...
        PluginSpec.Action(transforms_1.StateTransforms.Volume.VolumeTransform),
        PluginSpec.Action(transforms_1.StateTransforms.Volume.VolumeInstances),
    ],
    behaviors: [
        ...
        PluginSpec.Behavior(behavior_1.PluginBehaviors.State.SnapshotControls),
        ...
        PluginSpec.Behavior(behavior_1.PluginBehaviors.CustomProps.Streamlines),
    ],
    animations: [
        ...
        state_snapshots_1.AnimateStateSnapshotTransition,
