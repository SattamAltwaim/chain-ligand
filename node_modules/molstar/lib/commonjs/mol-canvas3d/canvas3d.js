...
exports.Canvas3D = exports.Canvas3DContext = exports.DefaultCanvas3DAttribs = exports.DefaultCanvas3DParams = exports.Canvas3DParams = exports.CameraFogParams = void 0;
...
const trackball_1 = require("./controls/trackball.js");
const util_1 = require("./camera/util.js");
const context_1 = require("../mol-gl/webgl/context.js");
...
const set_1 = require("../mol-util/set.js");
const interaction_events_1 = require("./helper/interaction-events.js");
const postprocessing_1 = require("./passes/postprocessing.js");
const multi_sample_1 = require("./passes/multi-sample.js");
const pick_1 = require("./passes/pick.js");
const pick_helper_1 = require("./helper/pick-helper.js");
const image_1 = require("./passes/image.js");
...
const handle_helper_1 = require("./helper/handle-helper.js");
const stereo_1 = require("./camera/stereo.js");
const helper_1 = require("./helper/helper.js");
const passes_1 = require("./passes/passes.js");
...
const hi_z_1 = require("./passes/hi-z.js");
const illumination_1 = require("./passes/illumination.js");
const browser_1 = require("../mol-util/browser.js");
const pointer_helper_1 = require("./helper/pointer-helper.js");
const xr_manager_1 = require("./helper/xr-manager.js");
const ray_helper_1 = require("./helper/ray-helper.js");
const produce_1 = require("../mol-util/produce.js");
const shader_manager_1 = require("./helper/shader-manager.js");
const number_1 = require("../mol-util/number.js");
exports.CameraFogParams = {
...
exports.Canvas3DParams = {
    ...
    cameraFog: param_definition_1.ParamDefinition.MappedStatic('on', {
        on: param_definition_1.ParamDefinition.Group(exports.CameraFogParams),
        off: param_definition_1.ParamDefinition.Group({})
    ...
    cameraClipping: param_definition_1.ParamDefinition.Group({
        ...
        minNear: param_definition_1.ParamDefinition.Numeric(1, { min: 0.1, max: 100, step: 0.1 }, { description: 'Minimal allowed distance of near clipping plane from the camera. Note, may cause performance issues rendering impostors when set too small and cause issues with outline rendering when too close to 0.' }),
    }, { pivot: 'radius' }),
    ...
    checkeredTransparentBackground: param_definition_1.ParamDefinition.Boolean(false),
    dpoitIterations: param_definition_1.ParamDefinition.Numeric(2, { min: 1, max: 10, step: 1 }),
    enableAnimation: param_definition_1.ParamDefinition.Boolean(true, { description: 'Enable GPU time-based animations (wiggle/tumble).' }),
    ...
    xr: param_definition_1.ParamDefinition.Group(xr_manager_1.XRManagerParams, { label: 'XR' }),
};
exports.DefaultCanvas3DParams = param_definition_1.ParamDefinition.getDefaultValues(exports.Canvas3DParams);
exports.DefaultCanvas3DAttribs = {
    trackball: trackball_1.DefaultTrackballControlsAttribs,
    xr: xr_manager_1.DefaultXRManagerAttribs,
};
var Canvas3DContext;
...
function syncCanvasBackground(canvas, canvasProps) {
...
(function (Canvas3D) {
    function create(ctx, props = {}, attribs = {}) {
        ...
        const a = { ...(0, object_1.deepClone)(exports.DefaultCanvas3DAttribs), ...(0, object_1.deepClone)(attribs) };
        ...
        const controls = trackball_1.TrackballControls.create(input, camera, scene, p.trackball, a.trackball);
        ...
        const shaderManager = new shader_manager_1.ShaderManager(webgl, scene);
        shaderManager.updateRequired(p);
        const pickOptions = {
            pickPadding: p.pickPadding,
            maxAsyncReadLag: pick_1.DefaultPickOptions.maxAsyncReadLag,
        };
        const pickHelper = new pick_helper_1.PickHelper(webgl, renderer, scene, helper, passes.pick, { x, y, width, height }, pickOptions);
        const rayHelper = new ray_helper_1.RayHelper(webgl, renderer, scene, helper, pickOptions);
        const interactionHelper = new interaction_events_1.Canvas3dInteractionHelper(identify, asyncIdentify, getLoci, input, camera, controls, p.interaction);
        ...
        function getNonXRProps() {
            return {
                ...
                axes: (0, object_1.deepClone)(helper.camera.props.axes),
            };
        }
        ...
        const xrManager = new xr_manager_1.XRManager(webgl, input, scene, camera, stereoCamera, helper.pointer, interactionHelper, p.xr, a.xr);
        const xr = {
            request: async () => {
                try {
            ...
            isSupported: new rxjs_1.BehaviorSubject(false),
            isPresenting: new rxjs_1.BehaviorSubject(false),
            requestFailed: new rxjs_1.Subject(),
        };
        ...
        function render(force, xrFrame) {
            ...
            if (passes.illumination.supported && p.illumination.enabled && !xrFrame) {
                ...
                if (shouldRender || multiSampleChanged || markingUpdated) {
                    ...
                    if (multi_sample_1.MultiSamplePass.isEnabled(p.multiSample) && !xrFrame) {
        ...
        function consoleStats() {
            const items = scene.renderables.map(r => ({
                ...
                'byteCount [MiB]': (0, number_1.toFixed)(r.getByteCount() / 1024 / 1024, 3),
            }));
        ...
        if (debug_1.isDebugMode && canvas) {
            ...
            input.click.subscribe(e => {
                if (!e.modifiers.control || e.button !== 2)
                    return;
                const p = identify(linear_algebra_1.Vec2.create(e.x, e.y));
                if (!p) {
        ...
        return {
            ...
            setProps: (properties, doNotRequestDraw = false) => {
                ...
                const props = typeof properties === 'function'
                    ? (0, produce_1.produce)(getProps(), properties)
                    : properties;
            ...
            getImagePass: (props = {}) => {
                return new image_1.ImagePass(webgl, assetManager, renderer, scene, camera, helper, props);
            },
            getRenderObjects() {
                const renderObjects = [];
