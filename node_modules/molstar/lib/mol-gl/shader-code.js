...
import { apply_fog } from './shader/chunks/apply-fog.glsl.js';
import { apply_interior_color } from './shader/chunks/apply-interior-color.glsl.js';
import { apply_light_color } from './shader/chunks/apply-light-color.glsl.js';
import { apply_marker_color } from './shader/chunks/apply-marker-color.glsl.js';
import { assign_clipping_varying } from './shader/chunks/assign-clipping-varying.glsl.js';
import { assign_color_varying } from './shader/chunks/assign-color-varying.glsl.js';
import { assign_group } from './shader/chunks/assign-group.glsl.js';
import { assign_marker_varying } from './shader/chunks/assign-marker-varying.glsl.js';
import { assign_material_color } from './shader/chunks/assign-material-color.glsl.js';
import { assign_position } from './shader/chunks/assign-position.glsl.js';
import { assign_size } from './shader/chunks/assign-size.glsl.js';
import { check_picking_alpha } from './shader/chunks/check-picking-alpha.glsl.js';
import { check_transparency } from './shader/chunks/check-transparency.glsl.js';
import { clip_instance } from './shader/chunks/clip-instance.glsl.js';
import { clip_pixel } from './shader/chunks/clip-pixel.glsl.js';
import { color_frag_params } from './shader/chunks/color-frag-params.glsl.js';
import { color_vert_params } from './shader/chunks/color-vert-params.glsl.js';
import { common_animation } from './shader/chunks/common-animation.glsl.js';
import { common_clip } from './shader/chunks/common-clip.glsl.js';
import { common_frag_params } from './shader/chunks/common-frag-params.glsl.js';
import { common_vert_params } from './shader/chunks/common-vert-params.glsl.js';
import { common } from './shader/chunks/common.glsl.js';
import { fade_lod } from './shader/chunks/fade-lod.glsl.js';
import { float_to_rgba } from './shader/chunks/float-to-rgba.glsl.js';
import { light_frag_params } from './shader/chunks/light-frag-params.glsl.js';
import { normal_frag_params } from './shader/chunks/normal-frag-params.glsl.js';
import { read_from_texture } from './shader/chunks/read-from-texture.glsl.js';
import { rgba_to_float } from './shader/chunks/rgba-to-float.glsl.js';
import { size_vert_params } from './shader/chunks/size-vert-params.glsl.js';
import { texture3d_from_1d_trilinear } from './shader/chunks/texture3d-from-1d-trilinear.glsl.js';
import { texture3d_from_2d_linear } from './shader/chunks/texture3d-from-2d-linear.glsl.js';
import { texture3d_from_2d_nearest } from './shader/chunks/texture3d-from-2d-nearest.glsl.js';
import { wboit_write } from './shader/chunks/wboit-write.glsl.js';
import { dpoit_write } from './shader/chunks/dpoit-write.glsl.js';
const ShaderChunks = {
    apply_fog,
...
;
import { points_vert } from './shader/points.vert.js';
import { points_frag } from './shader/points.frag.js';
export const PointsShaderCode = ShaderCode('points', points_vert, points_frag, { drawBuffers: 'optional' }, {}, ignoreDefineUnlit);
import { spheres_vert } from './shader/spheres.vert.js';
import { spheres_frag } from './shader/spheres.frag.js';
...
import { cylinders_vert } from './shader/cylinders.vert.js';
import { cylinders_frag } from './shader/cylinders.frag.js';
...
import { text_vert } from './shader/text.vert.js';
import { text_frag } from './shader/text.frag.js';
...
import { lines_vert } from './shader/lines.vert.js';
import { lines_frag } from './shader/lines.frag.js';
export const LinesShaderCode = ShaderCode('lines', lines_vert, lines_frag, { drawBuffers: 'optional' }, {}, ignoreDefineUnlit);
import { mesh_vert } from './shader/mesh.vert.js';
import { mesh_frag } from './shader/mesh.frag.js';
export const MeshShaderCode = ShaderCode('mesh', mesh_vert, mesh_frag, { drawBuffers: 'optional' }, {}, ignoreDefine);
import { directVolume_vert } from './shader/direct-volume.vert.js';
import { directVolume_frag } from './shader/direct-volume.frag.js';
...
import { image_vert } from './shader/image.vert.js';
import { image_frag } from './shader/image.frag.js';
...
export function addShaderDefines(gl, extensions, parameters, defines, shaders) {
