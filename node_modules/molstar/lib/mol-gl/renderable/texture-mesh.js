...
import { GlobalUniformSchema, BaseSchema, DefineSpec, InternalSchema, UniformSpec, TextureSpec, GlobalTextureSchema, ValueSpec, GlobalDefineSchema, InteriorSchema, AnimationSchema } from './schema.js';
...
export function TextureMeshRenderable(ctx, id, values, state, materialId, transparency, globals) {
