...
import { GlobalUniformSchema, BaseSchema, AttributeSpec, ElementsSpec, DefineSpec, InternalSchema, GlobalTextureSchema, ValueSpec, UniformSpec, GlobalDefineSchema, InteriorSchema, AnimationSchema } from './schema.js';
...
export function MeshRenderable(ctx, id, values, state, materialId, transparency, globals) {
