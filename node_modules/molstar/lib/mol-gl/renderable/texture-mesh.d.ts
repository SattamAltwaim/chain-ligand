...
import { DefineSpec, Values, UniformSpec, TextureSpec, ValueSpec, GlobalDefines } from './schema.js';
export declare const TextureMeshSchema: {
    uWiggleSpeed: UniformSpec<"f">;
    uWiggleAmplitude: UniformSpec<"f">;
    uWiggleFrequency: UniformSpec<"f">;
    uWiggleMode: UniformSpec<"i">;
    uTumbleSpeed: UniformSpec<"f">;
    uTumbleAmplitude: UniformSpec<"f">;
    uTumbleFrequency: UniformSpec<"f">;
    ...
    aInstance: import("./schema.js").AttributeSpec<"float32">;
    aTransform: import("./schema.js").AttributeSpec<"float32">;
    ...
    tWiggle: TextureSpec<"image-uint8">;
    dWiggle: DefineSpec<"boolean">;
    wiggleAverage: ValueSpec<"number">;
    dWiggleType: DefineSpec<"string">;
    uWiggleStrength: UniformSpec<"f">;
...
export declare function TextureMeshRenderable(ctx: WebGLContext, id: number, values: TextureMeshValues, state: RenderableState, materialId: number, transparency: Transparency, globals: GlobalDefines): Renderable<TextureMeshValues>;
