...
import { AttributeItemSize, ElementsKind, AttributeValues, AttributeKind, DataTypeArrayType } from '../webgl/buffer.js';
import { UniformKind, UniformValues, UniformKindValue } from '../webgl/uniform.js';
import { DefineKind, DefineValues } from '../shader-code.js';
import { Mat4 } from '../../mol-math/linear-algebra.js';
import { TextureValues, TextureType, TextureFormat, TextureFilter, TextureKind, TextureKindValue } from '../webgl/texture.js';
import { Sphere3D } from '../../mol-math/geometry.js';
import { InstanceGrid } from '../../mol-math/geometry/instance-grid.js';
...
export declare const GlobalUniformSchema: {
    ...
    readonly uHasHeadRotation: UniformSpec<"b">;
    readonly uInvHeadRotation: UniformSpec<"m4">;
    readonly uIsAsymmetricProjection: UniformSpec<"b">;
    readonly uHasEyeCamera: UniformSpec<"b">;
    readonly uModelViewEye: UniformSpec<"m4">;
    readonly uInvModelViewEye: UniformSpec<"m4">;
    ...
    readonly uModelScale: UniformSpec<"f">;
    ...
    readonly uTime: UniformSpec<"f">;
    readonly uEnableAnimation: UniformSpec<"b">;
};
...
export declare const GlobalDefineSchema: {
...
export declare const WiggleSchema: {
    readonly uWiggleTexDim: UniformSpec<"v2">;
    readonly tWiggle: TextureSpec<"image-uint8">;
...
export declare const InteriorSchema: {
