...
import { GlobalUniformSchema, BaseSchema, InternalSchema, SizeSchema, ValueSpec, DefineSpec, GlobalTextureSchema, UniformSpec, TextureSpec, GlobalDefineSchema, InteriorSchema, AnimationSchema } from './schema.js';
...
export function SpheresRenderable(ctx, id, values, state, materialId, transparency, globals) {
