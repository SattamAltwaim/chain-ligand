...
import { StructureRepresentation, StructureRepresentationProvider } from '../../../../mol-repr/structure/representation.js';
...
export declare const CustomLabelParams: {
    ...
    borderColor: {
        defaultValue: import("../../../../mol-util/color/index.js").Color;
        type: "color";
        isExpanded?: boolean;
        isOptional?: boolean;
        label?: string;
