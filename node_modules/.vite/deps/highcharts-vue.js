...
var require_highcharts_vue_min = __commonJS({
  "node_modules/highcharts-vue/dist/highcharts-vue.min.js"(exports, module) {
    !function(t, e) {
      "object" == typeof exports && "object" == typeof module ? module.exports = e(require_highcharts(), require_vue()) : "function" == typeof define && define.amd ? define(["highcharts", "vue"], e) : "object" == typeof exports ? exports.HighchartsVue = e(require_highcharts(), require_vue()) : t.HighchartsVue = e(t.Highcharts, t.Vue);
    }(window, function(r, n) {
      return i = [function(t, e) {
        ...
        function s(t2) {
          return function(t3) {
            if (Array.isArray(t3)) return n2(t3);
          }(t2) || function(t3) {
            if ("undefined" != typeof Symbol && null != t3[Symbol.iterator] || null != t3["@@iterator"]) return Array.from(t3);
          }(t2) || function(t3, e2) {
            var r3;
            if (t3) return "string" == typeof t3 ? n2(t3, e2) : "Map" === (r3 = "Object" === (r3 = Object.prototype.toString.call(t3).slice(8, -1)) && t3.constructor ? t3.constructor.name : r3) || "Set" === r3 ? Array.from(t3) : "Arguments" === r3 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r3) ? n2(t3, e2) : void 0;
          }(t2) || function() {
        ...
        function n2(t2, e2) {
          ...
          for (var r3 = 0, n3 = new Array(e2); r3 < e2; r3++) n3[r3] = t2[r3];
          return n3;
        }
        function p(e2, t2) {
        ...
        function o2(n3) {
          for (var t2 = 1; t2 < arguments.length; t2++) {
            ...
            t2 % 2 ? p(Object(o3), true).forEach(function(t3) {
              var e2, r3;
              e2 = n3, r3 = o3[t3 = t3], (t3 = function(t4) {
                t4 = function(t5, e3) {
                  if ("object" !== a(t5) || null === t5) return t5;
                  var r4 = t5[Symbol.toPrimitive];
                  if (void 0 === r4) return ("string" === e3 ? String : Number)(t5);
                  r4 = r4.call(t5, e3 || "default");
                  if ("object" !== a(r4)) return r4;
                  throw new TypeError("@@toPrimitive must return a primitive value.");
                }(t4, "string");
                return "symbol" === a(t4) ? t4 : String(t4);
              }(t3)) in e2 ? Object.defineProperty(e2, t3, { value: r3, enumerable: true, configurable: true, writable: true }) : e2[t3] = r3;
            }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(n3, Object.getOwnPropertyDescriptors(o3)) : p(Object(o3)).forEach(function(t3) {
              Object.defineProperty(n3, t3, Object.getOwnPropertyDescriptor(o3, t3));
            });
          }
          return n3;
        }
        var f = { template: '<div ref="chart"></div>', props: { constructorType: { type: String, default: "chart" }, options: { type: Object, required: true }, callback: Function, updateArgs: { type: Array, default: function() {
          return [true, true];
        } }, highcharts: { type: Object }, deepCopyOnUpdate: { type: Boolean, default: true } } }, l = function(r3, t2) {
          return t2.split(".")[0] < 3 ? o2(o2({}, f), {}, { render: function(t3) {
            return t3("div", { ref: "chart" });
          }, beforeDestroy: function() {
            this.chart && this.chart.destroy();
          }, watch: { options: { handler: function(t3) {
            var e2;
            (e2 = this.chart).update.apply(e2, [i2(t3, this.deepCopyOnUpdate)].concat(s(this.updateArgs)));
          }, deep: true } }, mounted: function() {
            var t3 = this.highcharts || r3;
            this.options && t3[this.constructorType] ? this.chart = t3[this.constructorType](this.$refs.chart, i2(this.options, true), this.callback || null) : this.options ? console.warn("'".concat(this.constructorType, "' constructor-type is incorrect. Sometimes this error is caused by the fact, that the corresponding module wasn't imported.")) : console.warn('The "options" parameter was not passed.');
          } }) : o2(o2({}, f), {}, { render: function() {
            return Object(u.h)("div", { ref: "chartContainer" });
          }, setup: function(n3) {
            var e2 = Object(u.ref)(null), o3 = Object(u.shallowRef)({});
            return Object(u.onMounted)(function() {
              var t3 = n3.highcharts || r3;
              n3.options && t3[n3.constructorType] ? o3.value = t3[n3.constructorType](e2.value, i2(n3.options, true), n3.callback || null) : n3.options ? console.warn("'".concat(n3.constructorType, "' constructor-type is incorrect. Sometimes this error is caused by the fact, that the corresponding module wasn't imported.")) : console.warn('The "options" parameter was not passed.');
            }), Object(u.watch)(function() {
              return n3.options;
            }, function(t3, e3) {
              var r4;
              (r4 = o3.value).update.apply(r4, [i2(t3, n3.deepCopyOnUpdate)].concat(s(n3.updateArgs)));
            }, { deep: true }), Object(u.onBeforeUnmount)(function() {
              o3.value && o3.value.destroy();
            }), { chart: o3, chartContainer: e2, props: n3 };
          } });
        }, h = l(c2.a, u.version || r2.n(u).a.version);
        function y(t2) {
          var e2 = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {};
          t2.component(e2.tagName || "highcharts", l(e2.highcharts || c2.a, t2.version));
        }
      }], c = {}, o.m = i, o.c = c, o.d = function(t, e, r2) {
        ...
        if (o.r(r2), Object.defineProperty(r2, "default", { enumerable: true, value: e }), 2 & t && "string" != typeof e) for (var n2 in e) o.d(r2, n2, (function(t2) {
          return e[t2];
        }).bind(null, n2));
        return r2;
      }, o.n = function(t) {
      ...
      function o(t) {
        var e;
        return (c[t] || (e = c[t] = { i: t, l: false, exports: {} }, i[t].call(e.exports, e, e.exports, o), e.l = true, e)).exports;
      }
      var i, c;
    });
  }
